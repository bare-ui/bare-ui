				...
				<div className="relative">
					...
					<Select.Content className={contentCls}>
						<Select.Group>
							...
							<Select.Item value="est" className={itemCls}>
								Eastern Time (EST)
							</Select.Item>
							<Select.Item value="cst" className={itemCls}>
								Central Time (CST)
							</Select.Item>
							<Select.Item value="pst" className={itemCls}>
								Pacific Time (PST)
							</Select.Item>
						</Select.Group>
						...
						<Select.Group>
							...
							<Select.Item value="gmt" className={itemCls}>
								Greenwich Mean Time (GMT)
							</Select.Item>
							<Select.Item value="cet" className={itemCls}>
		...
		<div className="w-64">
			<Select.Root>
				<div className="relative">
					...
					<Select.Content className={contentCls}>
						<Select.Item value="free" className={itemCls}>
							Free
						</Select.Item>
						<Select.Item value="pro" className={itemCls}>
							Pro
						</Select.Item>
						<Select.Item value="enterprise" disabled className={itemCls}>
							Enterprise{' '}
							<span className="ml-auto text-xs text-gray-400">Contact sales</span>
						</Select.Item>
					</Select.Content>
				</div>
			</Select.Root>

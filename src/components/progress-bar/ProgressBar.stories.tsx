...
export const Default: Story = {
	render: () => (
		<div className="w-80">
			<ProgressBar percentage={50} className={`${trackCls} ${sizeCls.medium}`} />
		</div>
	),
}
...
export const Empty: Story = {
	render: () => (
		<div className="w-80">
			<ProgressBar percentage={0} className={`${trackCls} ${sizeCls.medium}`} />
		</div>
	),
}
...
export const Full: Story = {
	render: () => (
		<div className="w-80">
			<ProgressBar percentage={100} className={`${trackCls} ${sizeCls.medium}`} />
		</div>
	),
}
	...
	render: () => (
		<div className="flex w-80 flex-col gap-4">
			<div>
				...
				<ProgressBar percentage={60} className={`${trackCls} ${sizeCls.small}`} />
			</div>
			<div>
				<p className="mb-1.5 text-xs text-gray-500">Medium (h-2)</p>
				<ProgressBar percentage={60} className={`${trackCls} ${sizeCls.medium}`} />
			</div>
			<div>
				<p className="mb-1.5 text-xs text-gray-500">Large (h-4)</p>
				<ProgressBar percentage={60} className={`${trackCls} ${sizeCls.large}`} />
			</div>
		</div>
	),
}
...
export const WithLabel: Story = {
	render: () => (
		<div className="w-80">
			...
			<ProgressBar percentage={68} className={`${trackCls} ${sizeCls.medium}`} />
	...
	render: () => {
		...
		return (
			<div className="w-80">
				...
				<ProgressBar percentage={progress} className={`${trackCls} ${sizeCls.medium}`} />
			</div>
		)
	},
}
...
export const Steps: Story = {
	render: () => (
		<div className="w-80">
			...
			<ProgressBar percentage={50} className={`${trackCls} ${sizeCls.large}`} />
		</div>
	),
}

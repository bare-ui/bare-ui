...
const faqs = [
	{
		value: 'item-1',
		question: 'What is bare-ui?',
		answer: 'bare-ui is a headless React 19 component library. It ships zero styles — you bring your own via className and data-attribute selectors.',
	},
	{
		value: 'item-2',
		question: 'How is it different from Headless UI?',
		answer: 'bare-ui uses the asChild pattern instead of the as prop, exports useInteractiveState publicly, and uses data-focus-visible (keyboard only) instead of data-focus.',
	},
	{
		value: 'item-3',
			...
			<div>
				...
				>
					{faqs.slice(0, 3).map((faq, i) => (
						<Accordion.Item key={faq.value} value={faq.value} disabled={i === 1}>

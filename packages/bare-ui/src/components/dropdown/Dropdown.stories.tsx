		...
		<div className='flex justify-end p-8'>
			<Dropdown.Root className='relative inline-block'>
				...
				<Dropdown.Menu
					...
					<div className='cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>Option A</div>
					<div className='cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>Option B</div>
					<div className='cursor-pointer px-4 py-2 text-sm text-gray-700 hover:bg-gray-100'>Option C</div>
				</Dropdown.Menu>
			</Dropdown.Root>
		</div>
	),

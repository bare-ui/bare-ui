/**
 * Screen-reader semantics for Image. A loaded image exposes its alt as the
 * accessible name; an empty-alt image is decorative and skipped by SRs; the
 * loading placeholder carries no stray announceable text.
 */

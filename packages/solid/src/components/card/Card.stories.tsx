...
export const Default: Story = {
	render: () => (
		<Card class='w-full max-w-sm rounded-[8px] border border-black bg-white p-5'>
			<h3 class='text-sm font-semibold text-black mb-1'>Card Title</h3>
...
export const Complex: Story = {
	render: () => (
		<Card class='w-full max-w-sm overflow-hidden rounded-[20px] border border-black bg-white'>
			<WireframePlaceholder height={180} />
			<div class='p-5'>
				<h3 class='text-sm font-semibold text-black mb-1'>Product Name</h3>

...
export const Default: StoryObj = {
	render: () => (
		<Button class='inline-flex cursor-pointer items-center justify-center rounded-[8px] border border-black px-4 py-2 bg-[#f5f5f5] text-sm font-medium text-black outline-none transition-colors [data-hover]:bg-black [data-hover]:text-white [data-active]:scale-95 [data-focus-visible]:ring-2 [data-focus-visible]:ring-black [data-focus-visible]:ring-offset-2 [data-disabled]:cursor-not-allowed [data-disabled]:opacity-50'>
			Styled Button
		</Button>
	),
};
...
export const Complex: StoryObj = {
	render: () => (
		<div class='flex flex-col gap-4'>
			<p class='text-xs font-medium uppercase tracking-wide text-[#6b7280]'>Data attributes showcase</p>
			<p class='text-sm text-[#6b7280]'>Hover, click, and tab to each button — data attributes change in real time.</p>
			<div class='flex flex-wrap gap-4'>
				<Button class='cursor-pointer rounded-[8px] border border-black bg-white px-4 py-2 text-sm text-black outline-none transition-colors [data-hover]:bg-black [data-hover]:text-white [data-active]:scale-95 [data-focus-visible]:ring-2 [data-focus-visible]:ring-black'>
					Hover me
				</Button>
				<Button class='cursor-pointer rounded-[8px] border border-black bg-white px-4 py-2 text-sm text-black outline-none transition-colors [data-hover]:bg-black [data-hover]:text-white [data-active]:scale-95 [data-focus-visible]:ring-2 [data-focus-visible]:ring-black'>
					Tab to me

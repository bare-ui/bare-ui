...
export interface CommandRootProps extends Omit<JSX.HTMLAttributes<HTMLDivElement>, 'onChange' | 'onSelect'> {
...
export type CommandInputProps = Omit<JSX.InputHTMLAttributes<HTMLInputElement>, 'value' | 'onChange'>;

export type CommandListProps = JSX.HTMLAttributes<HTMLDivElement>;

export interface CommandGroupProps extends JSX.HTMLAttributes<HTMLDivElement> {
	/** Optional heading rendered above the group's items. */
	heading?: JSX.Element;
}

export interface CommandItemProps extends Omit<JSX.HTMLAttributes<HTMLDivElement>, 'onSelect'> {
...
export type CommandSeparatorProps = JSX.HTMLAttributes<HTMLDivElement>;

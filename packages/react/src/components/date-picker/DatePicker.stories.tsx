...
const triggerCls = 'inline-flex cursor-pointer items-center gap-2 rounded-[8px] border border-black bg-white px-3 py-2 text-sm text-black outline-none hover:bg-[#f5f5f5] data-[state=open]:ring-2 data-[state=open]:ring-black data-[state=open]:ring-offset-1';
		...
		return (
			<div className='flex flex-col gap-2'>
				...
				<DatePicker.Root value={date} onChange={setDate} className='relative inline-block'>
					<DatePicker.Trigger className={triggerCls + ' w-64 justify-between'}>
						<DatePicker.Value placeholder={<span className='text-[#a3a3a3]'>Select a date</span>} />
						<svg className='size-4 text-[#6b7280]' viewBox='0 0 20 20' fill='currentColor'>
							<path d='M6 2a1 1 0 011 1v1h6V3a1 1 0 112 0v1h1a2 2 0 012 2v10a2 2 0 01-2 2H4a2 2 0 01-2-2V6a2 2 0 012-2h1V3a1 1 0 011-1z' />
						</svg>
					</DatePicker.Trigger>
	...
	render: () => {
		...
		return (
			<div className='flex w-full max-w-md flex-col gap-3'>
				<label className='text-sm font-medium text-black'>Trip dates</label>
				<div className='flex items-center gap-2'>
					<DatePicker.Root value={from} onChange={setFrom} className='relative inline-block flex-1'>
						<DatePicker.Trigger className={triggerCls + ' w-full justify-between'}>
							<DatePicker.Value placeholder={<span className='text-[#a3a3a3]'>Departure</span>} />
						</DatePicker.Trigger>
						<DatePicker.Content className={contentCls}>
							<PickerContent />
						</DatePicker.Content>
					...
					<DatePicker.Root value={to} onChange={setTo} className='relative inline-block flex-1'>
						<DatePicker.Trigger className={triggerCls + ' w-full justify-between'}>
							<DatePicker.Value placeholder={<span className='text-[#a3a3a3]'>Return</span>} />
						</DatePicker.Trigger>
						<DatePicker.Content className={contentCls}>
							<PickerContent />
						</DatePicker.Content>

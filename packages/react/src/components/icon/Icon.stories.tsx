...
export const Default: Story = {
	render: () => (
		<div className='flex items-center gap-8'>
			<Icon type='caret-down' icons={icons} size='small' className='[data-size=small]:size-4 text-black' />
			<Icon type='warning-triangle' icons={icons} size='small' className='[data-size=small]:size-4 text-black' />
			<Icon type='x' icons={icons} size='small' className='[data-size=small]:size-4 text-black' />
		</div>
	),
};

...
export interface InfiniteScrollRootProps extends React.HTMLAttributes<HTMLDivElement> {
...
export type InfiniteScrollSentinelProps = React.HTMLAttributes<HTMLDivElement>;

export type InfiniteScrollLoaderProps = React.HTMLAttributes<HTMLDivElement>;

export type InfiniteScrollEndMessageProps = React.HTMLAttributes<HTMLDivElement>;

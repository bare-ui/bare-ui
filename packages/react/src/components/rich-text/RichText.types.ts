...
export interface RichTextRootProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onChange'> {
...
export type RichTextToolbarProps = React.HTMLAttributes<HTMLDivElement>;

export interface RichTextActionProps extends React.ButtonHTMLAttributes<HTMLButtonElement> {
...
export type RichTextEditorProps = Omit<React.TextareaHTMLAttributes<HTMLTextAreaElement>, 'value' | 'onChange'>;

export type RichTextPreviewProps = React.HTMLAttributes<HTMLDivElement>;

	...
	render: () => (
		<Breadcrumb.Root>
			<Breadcrumb.List className={listCls}>
				...
				<Breadcrumb.Separator className={sepCls} />
				<Breadcrumb.Item current className={itemCurrentCls}>Profile</Breadcrumb.Item>
			</Breadcrumb.List>
		</Breadcrumb.Root>
	),
};
	...
	render: () => (
		<Breadcrumb.Root>
			<Breadcrumb.List className={listCls}>
				...
				<Breadcrumb.Separator className={sepCls}>›</Breadcrumb.Separator>
				<Breadcrumb.Item current className={itemCurrentCls}>Breadcrumb</Breadcrumb.Item>
			</Breadcrumb.List>
		</Breadcrumb.Root>
	),
};
...
export const Complex: Story = {
	render: () => (
		<Breadcrumb.Root>
			<Breadcrumb.List className={listCls}>
				<Breadcrumb.Item>
					<Breadcrumb.Link href='#' className={`${linkCls} flex items-center gap-1`}>
				...
				<Breadcrumb.Separator className={sepCls}>
					<svg className='inline size-3' viewBox='0 0 20 20' fill='currentColor'>
						<path d='M7 5l5 5-5 5V5z' />
					</svg>
				</Breadcrumb.Separator>
				<Breadcrumb.Item>
					<Breadcrumb.Link href='#' className={linkCls}>Projects</Breadcrumb.Link>
				</Breadcrumb.Item>
				<Breadcrumb.Separator className={sepCls}>
					<svg className='inline size-3' viewBox='0 0 20 20' fill='currentColor'>
						<path d='M7 5l5 5-5 5V5z' />
				...
				<Breadcrumb.Item current className={itemCurrentCls}>Q4 Roadmap</Breadcrumb.Item>
			</Breadcrumb.List>
		</Breadcrumb.Root>
	),
};

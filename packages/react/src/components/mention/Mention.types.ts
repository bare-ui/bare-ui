...
export type MentionInputProps = React.TextareaHTMLAttributes<HTMLTextAreaElement>;

export type MentionContentProps = React.HTMLAttributes<HTMLDivElement>;

export interface MentionItemsProps {
	children: (props: MentionItemRenderProps) => React.ReactNode;
}

export type MentionEmptyProps = React.HTMLAttributes<HTMLDivElement>;

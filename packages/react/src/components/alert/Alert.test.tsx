...
function renderAlert(rootProps: React.ComponentProps<typeof Alert.Root> = {}) {
	return render(
...
describe('Alert', () => {
	...
	it('isAutoDismissable: alert dismisses after dismissCountdown', async () => {
		vi.useFakeTimers();
	...
	it('isAutoDismissable: alert still present before countdown', async () => {
		vi.useFakeTimers();

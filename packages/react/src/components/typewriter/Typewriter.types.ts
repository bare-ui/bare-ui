...
export interface TypewriterRootProps extends Omit<React.HTMLAttributes<HTMLSpanElement>, 'children'> {
	/**
	 ...
	 */
	children?: React.ReactNode | ((state: TypewriterState) => React.ReactNode);
}
...
export type TypewriterTextProps = React.HTMLAttributes<HTMLSpanElement>;

export interface TypewriterCursorProps extends React.HTMLAttributes<HTMLSpanElement> {
	/**

...
export interface ChatRootProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'onSubmit'> {
...
export interface ChatListProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'children'> {
...
export interface ChatMessageProps extends Omit<React.HTMLAttributes<HTMLDivElement>, 'role'> {
...
export type ChatComposerProps = React.FormHTMLAttributes<HTMLFormElement>;
...
export type ChatSendProps = React.ButtonHTMLAttributes<HTMLButtonElement>;

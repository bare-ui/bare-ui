...
const Indicator = React.forwardRef<HTMLSpanElement, CheckboxIndicatorProps>(({ children, className, ...rest }, ref) => {
...
// Named exports expose the sub-components to Storybook's react-docgen (public API stays `Checkbox.*`).

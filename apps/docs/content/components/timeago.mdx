...
export default function App() {
  ...
  return (
    <div style={{ fontFamily: "'Patrick Hand', cursive" }} className="p-6 flex flex-col gap-8">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-4">Recent date</p>
        <div className="flex flex-col gap-3">
          <div>
            <span className="text-sm font-medium text-[#9ca3af]">Duration: </span>
      ...
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-4">Older dates</p>
        <div className="flex flex-col gap-3">
          <div>

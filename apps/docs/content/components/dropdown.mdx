...
<template>
  <DropdownRoot class="relative inline-block">
    <DropdownTrigger class="inline-flex items-center rounded-[8px] border-2 border-black bg-black px-4 py-2 text-sm font-medium text-white hover:bg-[#333]">
      Open Menu
    </DropdownTrigger>
    <DropdownMenu class="absolute left-0 top-full z-10 mt-1 w-48 overflow-hidden rounded-[20px] border-[3px] border-black bg-white py-1">

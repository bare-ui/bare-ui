  ...
  <ModalRoot :open="open" @open-change="open = $event">
    <ModalPortal>
      <ModalOverlay class="fixed inset-0 z-50 flex items-center justify-center bg-black/50 p-4">
        <ModalContent class="w-full max-w-md overflow-hidden rounded-[20px] border border-black bg-white p-6">
          ...
          <div class="flex gap-3">
            <ModalClose class="flex-1 rounded-[8px] border border-black py-2 text-sm font-medium text-black hover:bg-[#f5f5f5]">
              Cancel
            </ModalClose>
            <button

...
<template>
  <SearchRoot
    ...
    <SearchInput
      placeholder="Search frameworks..."
      class="w-full rounded-[8px] border-2 border-black bg-white px-3 py-2 text-sm text-black outline-none focus:ring-2 focus:ring-black focus:ring-offset-1"
    />
    <SearchContent class="absolute left-0 top-full z-10 mt-1 w-full rounded-[20px] border-[3px] border-black bg-white py-1">
      <SearchItem
...
">
  <Search.Input className="border-2 border-black" />

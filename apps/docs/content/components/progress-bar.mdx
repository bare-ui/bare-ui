...
const trackCls = 'w-full overflow-hidden rounded-full bg-gray-200 [&_[data-part=fill]]:h-full [&_[data-part=fill]]:rounded-full [&_[data-part=fill]]:bg-blue-600 [&_[data-part=fill]]:transition-[width] [&_[data-part=fill]]:duration-300'

export default function App() {
  return (
    <div className="p-6 flex flex-col gap-8">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-gray-400 mb-4">All percentages</p>
      ...
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-gray-400 mb-4">With label</p>
        <div className="w-80">
      ...
      <div>
        ...
        <div className="flex w-80 flex-col gap-4">
          <div>
            <p className="mb-1.5 text-xs text-gray-500">Small</p>
            <ProgressBar percentage={60} className={['h-1', trackCls].join(' ')} />
          </div>
          <div>
            <p className="mb-1.5 text-xs text-gray-500">Medium</p>
            <ProgressBar percentage={60} className={['h-2', trackCls].join(' ')} />
          </div>
          <div>
            <p className="mb-1.5 text-xs text-gray-500">Large</p>

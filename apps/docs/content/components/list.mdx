...
export default function App() {
  return (
    <div style={{ fontFamily: "'Patrick Hand', cursive" }} className="p-6 flex flex-col gap-8">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-3">With icons and dividers</p>
        <List className="w-72 divide-y divide-[#d4d4d4] overflow-hidden rounded-[8px] border-2 border-black bg-white">
          {[
            ...
            <li key={label} className="flex cursor-pointer items-center gap-3 px-4 py-3 text-sm text-black hover:bg-[#f5f5f5]">
              ...
              <svg className="ml-auto h-4 w-4 text-[#9ca3af]" viewBox="0 0 20 20" fill="currentColor">
      ...
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-3">Checklist</p>

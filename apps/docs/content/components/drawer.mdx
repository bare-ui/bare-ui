            ...
            <Drawer.Content className="fixed left-0 top-0 z-50 flex h-full w-64 flex-col bg-white shadow-xl">
                ...
                {navItems.map(({ label, icon }) => (
                  <button
                    ...
                    className={[
                      ...
                      active === label ? 'bg-blue-50 text-blue-700' : 'text-gray-700 hover:bg-gray-100',
                    ].join(' ')}>
              ...
              <div className="border-t border-gray-200 p-4">
                <div className="flex items-center gap-3">
                  <div className="flex h-9 w-9 items-center justify-center rounded-full bg-blue-600 text-sm font-semibold text-white">JD</div>
                  <div>

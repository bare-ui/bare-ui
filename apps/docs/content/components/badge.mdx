...
export default function App() {
  return (
    <div style={{ fontFamily: "'Patrick Hand', cursive" }} className="p-6 flex flex-col gap-8">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-4">On icons</p>
      ...
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-3">On nav items</p>

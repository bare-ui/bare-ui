...
export default function App() {
  return (
    <div style={{ fontFamily: "'Patrick Hand', cursive" }} className="p-6 flex flex-col gap-8">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-4">Styled</p>
      ...
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#9ca3af] mb-3">Data attributes showcase</p>
        <p className="text-sm text-[#9ca3af] mb-4">Hover, click, and tab to each button — data attributes change in real time.</p>

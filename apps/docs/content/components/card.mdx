...
<template>
  <Card class="w-full max-w-sm rounded-[8px] border-2 border-black bg-white p-4 flex items-center gap-4">
    <AvatarRoot class="relative inline-flex size-12 shrink-0 items-center justify-center overflow-hidden rounded-full border-2 border-black bg-[#f5f5f5]">

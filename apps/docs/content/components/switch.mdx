  ...
  {[
    ...
    <div key={label} className="flex items-center justify-between px-4 py-3">
      ...
      <Switch.Root
        ...
        <Switch.Thumb className="pointer-events-none inline-block size-5 translate-x-0 rounded-full border border-black bg-white transition-transform data-[checked]:translate-x-5" />
      </Switch.Root>
    </div>
  ))}
</div>
...
<template>
  <div class="w-80 divide-y divide-[#d4d4d4] rounded-[8px] border border-black bg-white">
    <div v-for="setting in settings" :key="setting.label" class="flex items-center justify-between px-4 py-3">
      ...
      <SwitchRoot
        ...
        <SwitchThumb class="pointer-events-none inline-block size-5 translate-x-0 rounded-full border border-black bg-white transition-transform data-[checked]:translate-x-5" />
      </SwitchRoot>
    </div>
  </div>
</template>
    ...
    {({ label, value, onChange }) => (
      <div class="flex items-center justify-between px-4 py-3">
        ...
        <Switch.Root
          ...
          onChange={onChange}
          class="relative inline-flex h-6 w-11 shrink-0 cursor-pointer items-center rounded-full border border-black bg-[#e5e5e5] transition-colors outline-none data-[checked]:bg-black data-[disabled]:cursor-not-allowed data-[disabled]:opacity-50 data-[focus-visible]:ring-2 data-[focus-visible]:ring-black data-[focus-visible]:ring-offset-2">
          <Switch.Thumb class="pointer-events-none inline-block size-5 translate-x-0 rounded-full border border-black bg-white transition-transform data-[checked]:translate-x-5" />
        </Switch.Root>
      </div>
    )}
  </For>

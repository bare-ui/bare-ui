...
Most component libraries bundle design decisions you can't escape. bare-ui takes the opposite approach: every component is a behaviour primitive. You get the logic, accessibility, and state tracking — nothing else.

```tsx
// bare-ui ships no styles. This is all you get:

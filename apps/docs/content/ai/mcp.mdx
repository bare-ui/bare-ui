...
<Callout type="default">
  **`0.3.0` (May 2026)** — Catalogue now covers the 17 new hooks/composables/primitives added in `@wire-ui/react`, `@wire-ui/vue`, and `@wire-ui/solid` 0.3. `list_hooks` and `get_hook` return them across all three frameworks.
</Callout>

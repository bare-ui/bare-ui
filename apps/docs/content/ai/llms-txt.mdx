...
Wire UI provides [llms.txt](https://llmstxt.org) files so AI coding assistants can understand the library's API, component patterns, and data attribute conventions when helping you write code.

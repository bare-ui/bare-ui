...
- **Complete component reference** — 70 components across seven categories (including the new AI components) with props, parts, and data attributes
- **Hooks / Composables / Primitives** — 33 building blocks across state, interaction, layout, observers, timing, storage, DOM, and utility categories (React/Vue expose as `useX`; Solid as `createX`)
- **Decision trees** — choosing form, overlay, AI/content, navigation, feedback, and hook primitives, plus styling approaches
- **Anti-patterns** — common mistakes with explanations

## Related

- [LLMs.txt](/docs/ai/llms-txt) — AI-readable documentation files
- [MCP Server](/docs/ai/mcp) — Direct tool access for AI coding agents

...
- **Complete component reference** — all 48 components across six categories with props, parts, and data attributes
- **Hooks / Composables / Primitives** — all 17 building blocks across state, interaction, layout, observers, and utility categories (React/Vue expose as `useX`; Solid as `createX`)
- **Decision trees** — choosing form, overlay, navigation, feedback, and hook primitives, plus styling approaches

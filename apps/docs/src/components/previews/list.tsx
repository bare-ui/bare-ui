...
export function ListPreview() {
  return (
    <div className="p-6 flex flex-col gap-8">
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#6b7280] mb-3">With icons and dividers</p>
      ...
      <div>
        <p className="text-xs font-medium uppercase tracking-wide text-[#6b7280] mb-3">Checklist</p>

...
export function AccordionComposed() {
  return (
    <div className="p-6 flex justify-center">
      <style>{'[data-state=closed] > .accordion-body { grid-template-rows: 0fr; } [data-state=open] > .accordion-body { grid-template-rows: 1fr; } .accordion-body { display: grid; transition: grid-template-rows 200ms; } .accordion-body > div { overflow: hidden; }'}</style>
      <Accordion.Root
        type="multiple"
...
const richFaqs = [
  { value: 'item-1', icon: '📦', question: 'Getting Started', description: 'Learn the basics of wire-ui', answer: 'Install the package, import your first component, and style it with Tailwind classes and data-attribute selectors.' },
  { value: 'item-2', icon: '🎨', question: 'Theming', description: 'Customize the look and feel', answer: 'wire-ui is headless — you own all the styles. Use CSS variables, Tailwind, or any styling solution you prefer.' },
  { value: 'item-3', icon: '⚡', question: 'Performance', description: 'Optimized for speed', answer: 'Tree-shakeable exports, zero runtime CSS, and minimal re-renders. Only ship what you use.' },
]

export function AccordionComplex() {
  return (
    <div className="p-6 flex justify-center">
      <Accordion.Root
        type="single"
